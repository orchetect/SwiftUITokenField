...
struct TokenizedString_Tests {
    ...
    @Test
    func tokenizedStringEncode() {
        #expect(TS([]).tokenizedString() == "")
        #expect(TS([.string("")]).tokenizedString() == "")
        #expect(TS([.string(" ")]).tokenizedString() == " ")
        #expect(TS([.string("  ")]).tokenizedString() == "  ")
        #expect(TS([.string(" "), .string(" ")]).tokenizedString() == "  ")
        #expect(TS([.string("a")]).tokenizedString() == "a")
        #expect(TS([.string("ab")]).tokenizedString() == "ab")
        #expect(TS([.string("a"), .string("b")]).tokenizedString() == "ab")

        #expect(TS([.token(.one)]).tokenizedString() == "%[one]")
        #expect(TS([.token(.one), .token(.two)]).tokenizedString() == "%[one]%[t-wo]")
        #expect(TS([.token(.one), .token(.two), .token(.three)]).tokenizedString() == "%[one]%[t-wo]%[th ree]")
        ...
        #expect(
            ...
            .tokenizedString()
            == "A very long string with %[one], %[t-wo] and %[th ree]."
        )
    }

    @Test
    func tokenizedStringStringSubstitution() {
        #expect(TS([]).string(substitution: { "\($0.value)" }) == "")
        #expect(TS([.string("")]).string(substitution: { "\($0.value)" }) == "")
        #expect(TS([.string(" ")]).string(substitution: { "\($0.value)" }) == " ")
        #expect(TS([.string("  ")]).string(substitution: { "\($0.value)" }) == "  ")
        #expect(TS([.string(" "), .string(" ")]).string(substitution: { "\($0.value)" }) == "  ")
        #expect(TS([.string("a")]).string(substitution: { "\($0.value)" }) == "a")
        #expect(TS([.string("ab")]).string(substitution: { "\($0.value)" }) == "ab")
        #expect(TS([.string("a"), .string("b")]).string(substitution: { "\($0.value)" }) == "ab")

        #expect(TS([.token(.one)]).string(substitution: { "\($0.value)" }) == "1")
        #expect(TS([.token(.one), .token(.two)]).string(substitution: { "\($0.value)" }) == "12")
        #expect(TS([.token(.one), .token(.two), .token(.three)]).string(substitution: { "\($0.value)" }) == "123")
    ...
    func tokenizedStringStringSubstitution_WithSeparator() {
        ...
        #expect(TS([.string(""), .string(" ")]).string(separator: "-", substitution: { "\($0.value)" }) == "- ")
        #expect(TS([.string(" "), .string(" ")]).string(separator: "-", substitution: { "\($0.value)" }) == " - ")
        #expect(TS([.string("a")]).string(separator: "-", substitution: { "\($0.value)" }) == "a")
        #expect(TS([.string("ab")]).string(separator: "-", substitution: { "\($0.value)" }) == "ab")
        #expect(TS([.string("a"), .string("b")]).string(separator: "-", substitution: { "\($0.value)" }) == "a-b")
